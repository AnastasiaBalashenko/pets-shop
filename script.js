...
const templates = document.querySelector('#item-template');

function cardMaker(shopItem) {
    const { title, description, tags, price, img } = shopItem;
    const item = templates.content.cloneNode(true);
